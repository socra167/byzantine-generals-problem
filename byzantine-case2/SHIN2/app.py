...
def send():
	...
	if lead is not None:
		...
		try:
			...
			response = requests.get('http://SHIN4:5003/?value=' + lead)
	...
	if(received == 3):
		...
		values = dict()
		if(len(maxVal) == 1):
			print('[SHIN2] possible : ' + maxVal[0], file=sys.stderr)
			return '[SHIN2] possible : ' + maxVal[0]
		else:
			print('[SHIN2] impossible!', file=sys.stderr)
			return '[SHIN2] impossible!'
	return ''
